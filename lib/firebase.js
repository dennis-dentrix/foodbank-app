...
// Function to add a borrowed item to the borrowedItems collection
export const addBorrowedItem = async (borrowedItem) => {
  const borrowedItemsRef = collection(db, "borrowedFood");
  await addDoc(borrowedItemsRef, borrowedItem);
};
